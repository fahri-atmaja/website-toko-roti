    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">  
                <?php 
                    if (isset($_POST['save'])) {
                        $perusahaan->simpan_perusahaan($_POST['nama'],$_POST['alamat'],$_POST['pemilik'],$_POST['kota'],$_POST['email']);
                ...
                <form method="POST" id="forminput" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Email Push Notification</label>
                        <input type="email" class="form-control" name="email" id="email" value="<?php echo $per['email']; ?>" placeholder="Masukan Email Perusahaan">
                    </div>
