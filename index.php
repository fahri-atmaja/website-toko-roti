  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">TOKO SBAKERY</a> 
      </div>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <?php
          if($_SESSION['login_admin']['status']==1){
          ?>
          <li>
            <a  class="active-menu" href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a>
          </li> 
          <li>
            <a  href="#"><i class="fa fa-money"></i> Produksi<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
                <a  href="index.php?page=barangpembelian"><i class="fa fa-cube"></i> Data Barang Produksi</a>
              </li>
              <li>
                <a  href="index.php?page=pembelian"><i class="fa fa-database"></i> Data Produksi</a>
              </li>
              <li>
          ...
          <li>
            <a  href="index.php?page=log"><i class="fa fa-database"></i>Activity Log </a>
          </li>
          <li>
            <a  href="index.php?page=eoq"><i class="fa fa-book"></i> E O Q</a>
          </li>
          <li>
          ...
          <li>
            ...
            <ul class="nav nav-second-level">
              ...
              <li>
                <a  href="index.php?page=laporanpembelian"><i class="fa fa-file-archive-o"></i> Produksi</a>
              </li>
              <li>
                <a  href="index.php?page=laporanprofit"><i class="fa fa-dollar"></i> Profit</a>
              </li>
              <li>
                <a  href="index.php?page=laporandiagram"><i class="fa fa-report"></i> Diagram Barang</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          ?>
           <?php
          if($_SESSION['login_admin']['status']==2){
          ?>
          <li>
            <a  class="active-menu" href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a>
          </li> 
          ...
          ?>
           <?php
          if($_SESSION['login_admin']['status']==3){
          ?>
          <li>
            <a  href="index.php?page=eoq"><i class="fa fa-book"></i> E O Q</a>
          </li>
      ...
      <div id="page-inner">
        <?php  
          if (isset($_GET['page'])) {
            ...
            elseif ($_GET['page']=="stokbaranggudang") {
              include 'stokbaranggudang.php';
            }
            ...
            elseif ($_GET['page']=="laporandiagram") {
              include 'laporandiagram.php';
            }
            elseif ($_GET['page']=="perusahaan") {
              include 'perusahaan.php';
            }
            elseif ($_GET['page']=="eoq") {
              include 'eoq.php';
            }
            elseif ($_GET['page']=="tambaheoq") {
              include 'tambaheoq.php';
            }
            elseif ($_GET['page']=="ubaheoq") {
              include 'ubaheoq.php';
            }
